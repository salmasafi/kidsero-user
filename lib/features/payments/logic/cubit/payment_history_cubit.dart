...
class PaymentHistoryCubit extends Cubit<PaymentHistoryState> {
  ...
  Future<void> loadPayments() async {
    try {
      debugPrint('[PaymentHistoryCubit] Loading payments...');
      ...
      debugPrint('[PaymentHistoryCubit] Loaded ${response.payments.length} plan payments and ${response.orgServicePayments.length} service payments');
      ...
      debugPrint('[PaymentHistoryCubit] Error loading payments: $e');
